...
public type PostCrmV3ObjectsCompaniesBatchRead_readQueries record {
...
public type GetCrmV3ObjectsCompanies_getpageQueries record {
...
public type GetCrmV3ObjectsCompaniesCompanyid_getbyidQueries record {
    # A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
    string[] associations?;
    # Whether to return only results that have been archived.
    boolean archived = false;
...
public type PatchCrmV3ObjectsCompaniesCompanyid_updateQueries record {
    # The name of a property whose values are unique for this object
    string idProperty?;
};
